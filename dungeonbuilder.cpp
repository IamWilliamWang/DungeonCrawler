...
bool MagicalDungeonBuilder::loadWeapons()
{
	...
	_weaponList.emplace_back(std::make_shared<weapons::ShortSword>());
	_weaponList.emplace_back(std::make_shared<weapons::BattleAxe>());
	_weaponList.emplace_back(std::make_shared<core::weapons::WizardsStaff>());
	_weaponList.emplace_back(std::make_shared<core::weapons::MagicWand>());
	return true;
}
...
std::shared_ptr<Dungeon> MagicalDungeonBuilder::buildDungeon()
{
	...
	room7->createWeapon(_weaponList);
	// add rooms into dungeon
	magicalDungeon->addRoom(room1);
	magicalDungeon->addRoom(room2);
	magicalDungeon->addRoom(room3);
	magicalDungeon->addRoom(room4);
	magicalDungeon->addRoom(room5);
	magicalDungeon->addRoom(room6);
